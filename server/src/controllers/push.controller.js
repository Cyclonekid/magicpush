...
class PushController {
  ...
  static async pushByToken(req, res) {
    try {
      ...
      const { title, content, type = 'text', channelType, extraData } = source;
      ...
      const result = await PushService.pushByToken(token, { title, content, type, url, channelType, extraData }, getRealIP(req));
  ...
  static async pushByEndpoint(req, res) {
    try {
      ...
      const { title, content, type = 'text', channelType, extraData } = req.body;
      ...
      const result = await PushService.pushByEndpoint(
        endpointId,
        req.user.userId,
        { title, content, type, url, channelType, extraData },
        getRealIP(req)
      );
